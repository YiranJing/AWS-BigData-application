...
class MeituanSpider_taicang(object):
    ...
    '''
    ## 太仓店
    baseUrl_1 = ("https://www.meituan.com/meishi/api/poi/getMerchantComment?uuid=57461b13249c4026be0d.1564202509.1.0.0&platform=1&partner=126&originUrl=https%3A%2F%2Fwww.meituan.com%2Fmeishi%2F179306008%2F&riskLevel=1&optimusCode=10&id=179306008&userId=&offset=")
    ...
    def run(self,number_comments):
        ...
        taglist_1, itemlist_1 = self.parse(url,'太仓店')
