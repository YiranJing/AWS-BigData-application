...
class MeituanSpider_shanghai(object):
    ...
    ## 上海世纪汇店铺
    baseUrl_1 = ("https://www.meituan.com/meishi/api/poi/getMerchantComment?uuid=57461b13249c4026be0d.1564202509.1.0.0&platform=1&partner=126&originUrl=https%3A%2F%2Fwww.meituan.com%2Fmeishi%2F179108554%2F&riskLevel=1&optimusCode=10&id=179108554&userId=")
     
    
    ## 上海东方路店
    baseUrl_2 = ("https://www.meituan.com/meishi/api/poi/getMerchantComment?uuid=57461b13249c4026be0d.1564202509.1.0.0&platform=1&partner=126&originUrl=https%3A%2F%2Fwww.meituan.com%2Fmeishi%2F152551521%2F&riskLevel=1&optimusCode=10&id=152551521&userId=")
    ...
    def run(self,number_comments):
        ...
        taglist_1, itemlist_1 = self.parse(url,'上海世纪汇店铺')
                
        url = self.baseUrl_2 + str(number_comments)+ '&offset=%s&pageSize=10&sortType=1'
        taglist_2, itemlist_2 = self.parse(url,'上海东方路店')
