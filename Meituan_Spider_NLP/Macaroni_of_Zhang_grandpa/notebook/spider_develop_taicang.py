...
class MeituanSpider_taicang(object):
    '''
    MeituanSpider class allows you to fetch all data from meituan api website.
    :Usage:
    '''
    ## 太仓店
    baseUrl_1 = ("https://www.meituan.com/meishi/api/poi/getMerchantComment?uuid=57461b13249c4026be0d.1564202509.1.0.0&platform=1&partner=126&originUrl=https%3A%2F%2Fwww.meituan.com%2Fmeishi%2F179306008%2F&riskLevel=1&optimusCode=10&id=179306008&userId=&offset=0&pageSize=10&sortType=1")
   
  
    
    def __init__(self, saveMode='csv'):
        print("Spider is ready for Taicang area")

    def run(self):
        url = self.baseUrl_1
        taglist, itemlist = self.parse(url)
