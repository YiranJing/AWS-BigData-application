...
- I show the example that how to read in data from **S3 buckets** and the **proper way to creat datafiles in S3**   [My SageMaker Notes](https://github.com/YiranJing/BigDataAnalysis/blob/master/Train_and_Deploy_Model_Using_AWS_SageMaker.pdf)
